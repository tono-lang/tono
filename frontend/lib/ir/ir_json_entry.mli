...
(* A handle method call: an op's own "impl" body or a field's own
   [= .field.method(args)] source. *)
val encode_op_impl_call : Ir.op_impl_call -> Ir.json
val decode_op_impl_call : Ir.json -> (Ir.op_impl_call, string) result
