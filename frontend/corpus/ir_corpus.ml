...
(* The full corpus, keyed by fixture file name. [resolved_wire] lives in
   [Ir_corpus2], split out to keep this file within the size budget. *)
...
let examples : (string * Ir.model) list =
  [
    ...
    ("resolved_wire", Ir_corpus2.resolved_wire);
  ]
