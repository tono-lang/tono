...
(* ── Foreign generic type instantiation ──────────────────────────────────── *)
    ...
    [
      ...
      ( "foreign-boundary",
        [
          ...
          Alcotest.test_case "instance duplicate has a span" `Quick
            instance_duplicate_has_a_span_on_the_second_occurrence;
          Alcotest.test_case "instance distinct arguments" `Quick
            instance_distinct_arguments_no_collision;
          Alcotest.test_case "instance arg not declared" `Quick
            instance_arg_not_a_declared_type;
          Alcotest.test_case "instance absent for non-generic" `Quick
            instance_absent_for_a_non_generic_handle;
          Alcotest.test_case "instance clause prints idempotently" `Quick
