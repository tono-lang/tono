...
/// A module whose only shape carries a constraint and that declares no operation:
/// the case where the validator needs the Validation category without the rest of
