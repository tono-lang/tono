...
/// v28 widened `CallArg` with `Map` (wire key `map`): a string-keyed map
/// literal, the value side of a `map[string]V` logical parameter, carried
/// as pairs in written order.
