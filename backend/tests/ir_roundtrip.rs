...
fn version_gate_rejects_unknown_version() {
    assert!(decode_model(r#"{"tono_ir_version":21,"modules":[]}"#).is_ok());
...
fn float_text_divergence_is_tolerated() {
    ...
    let doc = r#"{"tono_ir_version":21,"modules":[{"name":"m","operations":[],"ext_libs":[],"extensions":[],"tests":[],
...
fn decode_tolerates_omitted_optional_fields() {
    ...
    let doc = r#"{"tono_ir_version":21,"modules":[{"name":"m","shapes":[
    ...
    assert!(decode_model(r#"{"tono_ir_version":21}"#).is_ok());
}
...
fn sentinel_missing_required_field_fails_decode() {
    ...
    let bad = r#"{"tono_ir_version":21,"modules":[{"name":"m","operations":[],
...
fn extension_table_roundtrips() {
    ...
    let doc = r#"{"tono_ir_version":21,"modules":[{"name":"m","shapes":[],"operations":[],"tests":[],"ext_libs":[],
        "extensions":[
