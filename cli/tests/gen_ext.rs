...
const IR_WITH_EXT: &str = r#"{"tono_ir_version":18,"modules":[{"name":"demo","shapes":[{"id":"demo#Charge","kind":"structure","params":[],"members":[{"name":"amount","required":true,"target":{"prim":"i64"},"constraints":[],"traits":[]}],"operations":[]}],"operations":[],"ext_libs":[{"name":"companyconfig","langs":[{"lang":"go","path":"github.com/company/config"},{"lang":"ts","path":"@company/config"},{"lang":"rust","path":"company-config"}]}]}]}"#;
