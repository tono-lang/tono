...
const IR_V1: &str = r#"{"tono_ir_version":20,"modules":[{"name":"spec","shapes":[{"id":"spec#Charge","kind":"structure","params":[],"members":[{"name":"amount","required":true,"target":{"prim":"i64"},"constraints":[],"traits":[]}],"operations":[]}],"operations":[]}]}"#;

/// The evolved IR: the same structure grows a `currency` member.
const IR_V2: &str = r#"{"tono_ir_version":20,"modules":[{"name":"spec","shapes":[{"id":"spec#Charge","kind":"structure","params":[],"members":[{"name":"amount","required":true,"target":{"prim":"i64"},"constraints":[],"traits":[]},{"name":"currency","required":true,"target":{"prim":"string"},"constraints":[],"traits":[]}],"operations":[]}],"operations":[]}]}"#;
